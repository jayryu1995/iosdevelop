...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        log(vc: viewControllerName, message: "system Version : \(device.systemVersion)")
        log(vc: viewControllerName, message: "device : \(device.name)")
        log(vc: viewControllerName, message: "uuid : \(uuid!)")
        log(vc: viewControllerName, message: "appVersion : \(appVersion!)")
