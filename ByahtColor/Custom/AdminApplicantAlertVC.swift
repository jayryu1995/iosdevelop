//
//  AdminApplicantAlertVC.swift
//  ByahtColor
//
//  Created by jaem on 4/5/24.
//
import UIKit
import SnapKit

class AdminApplicantAlertVC: UIViewController {
    ...
    private func setupAlertView() {
        ...
        // messageLabel 설정
        messageLabel.text = "신청결과를 변경하시겠습니까?"
        messageLabel.numberOfLines = 0
        messageLabel.font = UIFont(name: "Pretendard-Regular", size: 14)
        messageLabel.textAlignment = .center

        // confirmButton 설정
        confirmButton.setTitle("변경", for: .normal)
