...
class BusinessProfileVC: UIViewController {
    ...
    private func setupTableView() {
        ...
        tableView.register(BusinessTagetCell.self, forCellReuseIdentifier: "BusinessTagetCell")
...
extension BusinessProfileVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 1:
            ...
            return cell
        case 2:
            let cell = tableView.dequeueReusableCell(withIdentifier: "BusinessTagetCell", for: indexPath) as! BusinessTagetCell
            if let data = profileDto {
                ...
                if let nation = data.nation { strArray.append(nation)}
                cell.selectionStyle = .none
