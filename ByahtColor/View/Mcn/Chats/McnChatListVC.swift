...
//  ByahtColor
//
//  Created by jaem on 10/2/24.
//

import UIKit
import SendbirdChatSDK
import SnapKit
class McnChatListVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        useCase.reloadMcnChannels(withInfluenceId: influenceId)
    }
...
extension McnChatListVC: UITableViewDataSource {
...
extension McnChatListVC: UITableViewDelegate {
...
extension McnChatListVC: GroupChannelListUseCaseDelegate {
