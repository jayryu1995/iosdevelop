...
class McnInfluenceProfileVC: UIViewController {
    ...
    @objc private func buttonTapped() {
        ...
        vc.influenceId = self.influenceId
        self.navigationController?.pushViewController(vc, animated: false)
    }
}

extension McnInfluenceProfileVC: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            case 3:
                ...
                if let profile = viewModel.profileData {
                    ...
                    if let nation = profile.nation { strArray.append(nation) }
