//
//  InfluenceSwipeGuideVC.swift
//  ByahtColor
//
//  Created by jaem on 8/22/24.
//

import UIKit
import SnapKit

class InfluenceSwipeGuideVC: UIViewController {
    ...
    private let label = {
        let label = UILabel()
        label.text = "influence_sample_chat".localized
    ...
    private let icon: UIImageView = {
        let image = UIImageView(image: UIImage(named: "icon_propose"))
