...
class InfluenceOnboardingVC: UIViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    private func setupPages() {
        let firstView = FirstOnboardingVC()
        let secondView = SecondOnboardingVC()
        let thridView = ThirdOnboardingVC()
        let fourthView = FourthOnboardingVC()
