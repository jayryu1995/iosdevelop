...
class TestSelectionView2: UIViewController {
    ...
    private func setupContentStackViews() {
        ...
        // 상단 뷰 설정
        topTitleLabel.text = "Màu sắc cá nhân\nkiểm tra toàn diện"
        ...
        let descriptions = ["Nhe nhàn /\nTràn đầy sức sống", "Mát mẻ /\nSắc sỡ", "Điểm đậm /\nẤm áp", "Lạnh /\nĐơn giản"]
    ...
    private func setupStackView() {
        ...
        if User.shared.color != nil {
            ...
            let label1 = UILabel()
            label1.text = "Your personal color is"
            label1.textAlignment = .left
            label1.font = UIFont(name: "Pretendard-Regular", size: 14)

            let label2 = UILabel()
            let text = "Winter Cool Bright"
