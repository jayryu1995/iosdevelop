...
class CompareCameraView2: UIViewController {
    ...
    private func setImageView() {
        ...
        imageView.image = CreateBackgroundImage().drawSingleWholeBackground(size: size, color: GETCOLOR[0][0])
    ...
    private func resetView() {
        ...
        imageView.image = CreateBackgroundImage().drawSingleWholeBackground(size: view.frame.size, color: GETCOLOR[stage-1][0])
