...
class ModifyBoardVC: UIViewController, UITextViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
extension ModifyBoardVC: UITableViewDelegate, UITableViewDataSource {
