...
class CollabWriteVC: UIViewController, UIScrollViewDelegate, UINavigationControllerDelegate {
    ...
    private let lbl_people: UILabel = {
        let label = UILabel()
        label.text = "collabWriteVC_people_label_kr".localized
        label.font = UIFont(name: "Pretendard-SemiBold", size: 14)
        return label
    }()
    private let tf_people: UITextField = {
        let textView = UITextField()
        textView.text = "collabWriteVC_people_field_kr".localized
        textView.font = UIFont(name: "Pretendard-Regular", size: 14)
        textView.textColor = .lightGray
        textView.layer.borderColor = UIColor(hex: "#BCBDC0").cgColor
        textView.layer.cornerRadius = 4
    ...
    private let lbl_code: UILabel = {
        let label = UILabel()
        label.text = "collabWriteVC_code_label_kr".localized
        label.font = UIFont(name: "Pretendard-SemiBold", size: 14)
        return label
    }()
    private let tf_code: UITextField = {
        let textView = UITextField()
        textView.text = "collabWriteVC_code_field_kr".localized
        textView.font = UIFont(name: "Pretendard-Regular", size: 14)
        textView.textColor = .lightGray
        textView.layer.borderColor = UIColor(hex: "#BCBDC0").cgColor
        textView.layer.cornerRadius = 4
...
extension CollabWriteVC: UIImagePickerControllerDelegate, UITextViewDelegate, UITextFieldDelegate {
    ...
    func textViewDidBeginEditing(_ textView: UITextView) {
        ...
        if textView == tf_code && textView.text == "collabWriteVC_code_field_kr".localized {
            textView.text = ""
            textView.textColor = .black
        }
        if textView == tf_people && textView.text == "collabWriteVC_people_field_kr".localized {
            textView.text = ""
            textView.textColor = .black
        }
    }
    ...
    func textFieldDidBeginEditing(_ textField: UITextField) {
        ...
        if textField == tf_people && textField.text == "collabWriteVC_people_field_kr".localized {
            textField.text = ""
            textField.textColor = .black
        }
        if textField == tf_code && textField.text == "collabWriteVC_code_field_kr".localized {
            textField.text = ""
            textField.textColor = .black
        }
    }
    ...
    func textFieldDidEndEditing(_ textField: UITextField) {
        ...
        if textField == tf_people && textField.text!.isEmpty {
            textField.text = "collabWriteVC_people_field_kr".localized
            textField.textColor = .lightGray
        }

        if textField == tf_code && textField.text!.isEmpty {
            textField.text = "collabWriteVC_code_field_kr".localized
            textField.textColor = .lightGray
        }
    }
}
