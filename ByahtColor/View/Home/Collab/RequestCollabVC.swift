...
class RequestCollabVC: UIViewController, UIScrollViewDelegate, UINavigationControllerDelegate {
    ...
    private let snsLabel: UILabel = {
        let label = UILabel()
        label.text = "request_collab_platform_label".localized
    ...
    private let emailLabel: UILabel = {
        let label = UILabel()
        label.text = "request_collab_email_label".localized
        label.font = UIFont(name: "Pretendard-SemiBold", size: 14)
        return label
    }()
    ...
    private let emailField: UnderlinedTextField = {
        ...
        field.configure(withPlaceholder: "request_collab_email_placeholder".localized, font: UIFont(name: "Pretendard-Regular", size: 14))
        return field
    }()

    private let linkLabel: UILabel = {
        let label = UILabel()
        label.text = "request_collab_link_label".localized
        label.font = UIFont(name: "Pretendard-SemiBold", size: 14)
        return label
    }()
    ...
    private let linkField: UnderlinedTextField = {
        let field = UnderlinedTextField()
        field.configure(withPlaceholder: "request_collab_link_placeholder".localized, font: UIFont(name: "Pretendard-Regular", size: 14))
        return field
    }()

    private let nameLabel: UILabel = {
        let label = UILabel()
        label.text = "request_collab_name_label".localized
        label.font = UIFont(name: "Pretendard-SemiBold", size: 14)
        return label
    }()
    ...
    private let nameField: UnderlinedTextField = {
        let field = UnderlinedTextField()
        field.configure(withPlaceholder: "request_collab_name_placeholder".localized, font: UIFont(name: "Pretendard-Regular", size: 14))
        return field
    }()

    private let bankLabel: UILabel = {
        let label = UILabel()
        label.text = "request_collab_bank_label".localized
        label.font = UIFont(name: "Pretendard-SemiBold", size: 14)
        return label
    }()
    ...
    private let bankButton: UIButton = {
        let button = UIButton()
        button.setTitle("request_collab_bank_button".localized, for: .normal)
    ...
    private let refundsLabel: UILabel = {
        let label = UILabel()
        label.text = "request_collab_account_label".localized
        label.font = UIFont(name: "Pretendard-SemiBold", size: 14)
        return label
    }()
    ...
    private let refundsField: UnderlinedTextField = {
        let field = UnderlinedTextField()
        field.configure(withPlaceholder: "request_collab_account_placeholder".localized, font: UIFont(name: "Pretendard-Regular", size: 14))
    ...
    private let telLabel: UILabel = {
        let label = UILabel()
        label.text = "request_collab_phone_label".localized
        label.font = UIFont(name: "Pretendard-SemiBold", size: 14)
        return label
    }()
    ...
    private let telField: UnderlinedTextField = {
        let field = UnderlinedTextField()
        field.configure(withPlaceholder: "request_collab_phone_placeholder".localized, font: UIFont(name: "Pretendard-Regular", size: 14))
        field.keyboardType = .numberPad
        return field
    }()
    ...
    private let addressLabel: UILabel = {
        let label = UILabel()
        label.text = "request_collab_address_label".localized
        label.font = UIFont(name: "Pretendard-SemiBold", size: 14)
        return label
    }()
    ...
    private let addressField: UnderlinedTextField = {
        let field = UnderlinedTextField()
        field.configure(withPlaceholder: "request_collab_address_placeholder".localized, font: UIFont(name: "Pretendard-Regular", size: 14))
        return field
    }()
    ...
    private let submitButton: UIButton = {
        ...
        button.setTitle("request_collab_submit_button".localized, for: .normal)
