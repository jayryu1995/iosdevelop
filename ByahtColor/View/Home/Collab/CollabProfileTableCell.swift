...
import AlamofireImage
 ...
 class CollabProfileTableCell: UITableViewCell {
    weak var delegate: CollabProfileTableCellDelegate?
 ...
 protocol CollabProfileTableCellDelegate: AnyObject {
