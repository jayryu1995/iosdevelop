//
//  DiscountWriteVC.swift
//  ByahtColor
//
//  Created by jaem on 5/14/24.
//
...
class UserDiscountWriteVC: UIViewController, UIScrollViewDelegate, UINavigationControllerDelegate {
    ...
    @objc private func uploadButtonTapped() {
        ...
        let url = "\(Bundle.main.TEST_URL)/discount/insert"
        let headers: HTTPHeaders = ["Content-type": "multipart/form-data"]
        let nickname: String = User.shared.nickname ?? ""
        ...
        AF.upload(multipartFormData: { multipartFormData in
            ...
            multipartFormData.append(Data(style.utf8), withName: "type")
...
extension UserDiscountWriteVC: UIImagePickerControllerDelegate, UITextViewDelegate, UITextFieldDelegate {
