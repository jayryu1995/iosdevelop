...
class UserDiscountBeautyVC: UIViewController {
    private var viewModel = DiscountViewModel()
    private var cancellables = Set<AnyCancellable>()
    private let viewControllerName = String(describing: type(of: UserDiscountBeautyVC.self))
    ...
    private func clearAndReloadTableView() {
        ...
        var url = ""
        switch category {
        case 1: url = "\(Bundle.main.TEST_URL)/discount/sel2/Beauty"
        default: url = "\(Bundle.main.TEST_URL)/discount/sel/Beauty"
        }
...
extension UserDiscountBeautyVC: UITableViewDataSource, UITableViewDelegate,
